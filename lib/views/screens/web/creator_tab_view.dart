...
class _CreatorTabViewState extends State<CreatorTabView> {
  ...
  Widget _buildTrustBanner() {
    return LayoutBuilder(builder: (context, constraints) {
      ...
      return Container(
        padding:
            EdgeInsets.symmetric(vertical: isMobile ? 40 : 80, horizontal: 24),
        child: Column(
          children: [
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 24),
            Text(
                "We've eliminated the administrative burden of high-stakes assessment, allowing\nyou to focus on the human element of teaching.",
                textAlign: isMobile ? TextAlign.center : TextAlign.start,
                style: GoogleFonts.inter(
                ...
                ? Column(
                    children: [
                      _buildFrameworkCard(
                          Icons.science,
                          'Exam Architect',
                          'Maintain absolute control over academic rigor. Map questions to Bloom\'s Taxonomy with precision scoring.',
                          ['TAXONOMY MAPPING', 'AUTO-BALANCING']),
                      const SizedBox(height: 24),
                      _buildFrameworkCard(
                          Icons.insights,
                          'Real-time Analytics',
                          'Identify conceptual bottlenecks instantly. See beyond the score to understand the "why" of student performance.',
                          ['CONCEPT DRILLS', 'COHORT TRENDS']),
                      const SizedBox(height: 24),
                      _buildFrameworkCard(
                          Icons.all_inclusive,
                          'Knowledge Fusion',
                          'Synthesize diverse sources—from PDFs to lecture transcripts—into coherent, verified study modules.',
                          ['MULTI-SOURCE', 'AUTO-SUMMARIES']),
                    ],
                  )
                : IntrinsicHeight(
                    child: Row(
  ...
  Widget _buildFrameworkCard(
      IconData icon, String title, String desc, List<String> tags) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
                color: const Color(0xFFF3E8FF), shape: BoxShape.circle),
            ...
            isMobile
                ...
                : Row(
                    ...
                    children: [
                      Expanded(
                          flex: 1,
                          child: _buildDeepScanImage1(isMobile: false)),
                      const SizedBox(width: 80),
                      Expanded(
                          flex: 1,
                          child: _buildDeepScanContent1(isMobile: false)),
                    ],
                  ),
            ...
            isMobile
                ...
                : Row(
                    ...
                    children: [
                      Expanded(
                          flex: 1,
                          child: _buildDeepScanContent2(isMobile: false)),
                      const SizedBox(width: 80),
                      Expanded(
                          flex: 1,
                          child: _buildDeepScanImage2(isMobile: false)),
                    ],
                  ),
          ],
        ),
  ...
  Widget _buildDeepScanContent1({required bool isMobile}) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 24),
        Text(
            'Our interface was developed in collaboration with\nresearch professors to minimize cognitive load. Every\nfeature is exactly where you expect it to be.',
            textAlign: isMobile ? TextAlign.center : TextAlign.start,
            style: GoogleFonts.inter(
                fontSize: 16, color: Colors.grey[600], height: 1.5)),
        const SizedBox(height: 48),
        _featureHighlight('Native LMS Integration',
            'Sync grades and rosters with Canvas, Blackboard, and Moodle in one click.',
            isMobile: isMobile),
        const SizedBox(height: 32),
        _featureHighlight('Automated Feedback Loops',
            'Personalized feedback generated for every student based on their unique friction points.',
            isMobile: isMobile),
      ],
    );
  }
              ...
              Row(
                ...
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Dr. Audrina Malek',
                          style: GoogleFonts.inter(
                              fontSize: 14, fontWeight: FontWeight.bold)),
                      Text('Professor of Applied Physics',
                          style: GoogleFonts.inter(
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          child:
              const Icon(Icons.check, size: 16, color: WebColors.purplePrimary),
        ),
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 32),
              Text(
                  'Join a community of elite educators using data-driven pedagogical\ntools to transform student outcomes.',
                  textAlign: TextAlign.center,
                  style: GoogleFonts.inter(
              ...
              const SizedBox(height: 48),
              Text('GET A DEMO IN POST OR READ SALES',
                  style: GoogleFonts.inter(
                      fontSize: 10,
                      fontWeight: FontWeight.bold,
                      letterSpacing: 1.5,
          ...
          child: isMobile
              ? Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    Text('The intelligence layer for modern education.',
                        style: GoogleFonts.inter(
                            fontSize: 14,
                    ...
                    const SizedBox(height: 24),
                    _footerCol('COMPANY',
                        ['About Us', 'Careers', 'Privacy Policy', 'Contact']),
                    const SizedBox(height: 24),
