...
class _LandingPageWebState extends State<LandingPageWeb>
  ...
  Widget _buildConnector() {
    return Container(
      ...
      width: 40,
      child: Divider(color: Colors.grey[300], thickness: 2, indent: 8, endIndent: 8),
    );
  }
  ...
  Widget _buildCheckFeature(String text) {
    return Row(
      children: [
        ...
        const SizedBox(width: 16),
        Text(text, style: GoogleFonts.inter(fontSize: 15, fontWeight: FontWeight.w600, color: const Color(0xFF1F1F1F))),
      ],
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 24),
          Text('"$quote"', style: GoogleFonts.inter(fontSize: 14, color: Colors.grey[700], height: 1.6, fontStyle: FontStyle.italic)),
          const SizedBox(height: 32),
          Row(
            children: [
              CircleAvatar(backgroundColor: Colors.grey[300], radius: 16, child: const Icon(Icons.person, color: Colors.white, size: 16)),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(name, style: GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.bold, color: const Color(0xFF1F1F1F))),
                    Text(school, style: GoogleFonts.inter(fontSize: 11, color: Colors.grey[500]), overflow: TextOverflow.ellipsis,),
                  ],
                ),
              )
            ],
  ...
  Widget _buildCtaSection() {
    return Container(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            Text('Ready to study\nsmarter?', textAlign: TextAlign.center, style: GoogleFonts.outfit(fontSize: 48, fontWeight: FontWeight.w900, color: Colors.white, height: 1.1, letterSpacing: -1)),
            const SizedBox(height: 24),
            Text('Join thousands of students who are reclaiming their time and topping\ntheir classes with AI.', textAlign: TextAlign.center, style: GoogleFonts.inter(fontSize: 16, color: Colors.white70, height: 1.5)),
            const SizedBox(height: 40),
            ElevatedButton(
              onPressed: () => context.go('/auth'),
              style: ElevatedButton.styleFrom(
              ...
              child: Text('Get Started for Free', style: GoogleFonts.inter(fontWeight: FontWeight.bold, fontSize: 16)),
            ),
            const SizedBox(height: 24),
            Row(
              ...
              children: [
                ...
                const SizedBox(width: 8),
                Text('No credit card', style: GoogleFonts.inter(fontSize: 12, color: Colors.white70)),
                const SizedBox(width: 24),
                const Icon(Icons.check_circle, color: Colors.white54, size: 14),
                const SizedBox(width: 8),
                Text('Cancel anytime', style: GoogleFonts.inter(fontSize: 12, color: Colors.white70)),
              ],
            )
          ],
        ),
  ...
  Widget _footerCol(String title, List<String> links) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(title, style: GoogleFonts.inter(fontSize: 10, fontWeight: FontWeight.bold, letterSpacing: 1.5, color: Colors.white)),
        const SizedBox(height: 24),
        ...links.map((e) => Padding(
          padding: const EdgeInsets.only(bottom: 16),
          child: Text(e, style: GoogleFonts.inter(fontSize: 12, color: Colors.grey[400])),
        )),
      ],
    );
  }
