...
class FeedbackInsights extends StatelessWidget {
          ...
          children: [
            if (isMobile) ...[
              SharedTeacherWidgets.moduleHeader(
                  'AI Feedback', 'Failure patterns & interventions',
                  isMobile: true),
                ...
                children: [
                  Expanded(
                    child: ElevatedButton.icon(
                      onPressed:
                          isGeneratingFeedback ? null : onGenerateFeedback,
      ...
      child: Column(
        ...
        children: [
          ...
          if (feedbackInsight == null)
            Text(
                'Run the AI generator to discover deep learning patterns and struggles.',
          ...
          Center(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: Colors.white.withValues(alpha: 0.2), width: 12),
              ),
              child: Center(
                child: Column(
      ...
      child: Column(
        ...
        children: [
          ...
          _interventionRow(
              ...
              'Sarah Tan',
              'Top Tier',
              'Ready for advanced variable integration modules.',
              'EXTENSION TASK',
              'Assign Task',
              Colors.grey[300]!,
          ...
          _interventionRow(
              ...
              'James Park',
              'Steady',
              'Inconsistent terminology usage in written responses.',
              'VOCAB REVIEW',
              'Note AI',
              Colors.grey[300]!,
              textCol: Colors.black87,
  ...
  Widget _interventionRow(String initials, String name, String cluster,
      String insight, String intervention, String action, Color actionBtnColor,
      {Color textCol = Colors.white, bool isMobile = false}) {
    final clusterColor = cluster == 'Declining'
        ? Colors.red[100]
        : (cluster == 'Top Tier' ? Colors.green[100] : Colors.grey[200]);
    final clusterTextInfo = cluster == 'Declining'
        ? Colors.red[800]
        : (cluster == 'Top Tier' ? Colors.green[800] : Colors.grey[700]);
