...
class _StudentLandingViewState extends State<StudentLandingView> {
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            _buildTabToggle(),
            _buildStudentHeroSection(isMobile),
            _buildStepsSection(isMobile),
            _buildFeatureGridSection(isMobile),
            _buildReviewsSection(isMobile),
            _buildCtaSection(isMobile),
            _buildStudentFooter(isMobile),
          ],
        ),
      ),
    );
  ...
  Widget _buildStudentHeroSection(bool isMobile) {
  ...
  Widget _buildFeatureGridSection(bool isMobile) {
    final hPad = isMobile ? 24.0 : 80.0;
    return Container(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 24),
            Text(
                'Join thousands of students who are reclaiming their time and topping\ntheir classes with AI.',
                textAlign: TextAlign.center,
                style: GoogleFonts.inter(
