                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const SizedBox(width: 16),
                        _buildBadge(
                            Icons.auto_awesome_rounded, 'AI-Ready Parsing'),
                      ],
                    ),
                  ],
                ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildInputGroup(
              'EXAM TITLE', titleController, 'e.g., Midterm: Cellular Biology'),
          const SizedBox(height: 12),
          _buildInputGroup('SCHOOL / INSTITUTION', schoolNameController,
              'e.g., SumQuiz Academy',
            ...
            children: [
              Expanded(
                  child: _buildInputGroup(
                      'SUBJECT/DOMAIN', subjectController, 'e.g., Biology',
                      prefixIcon: Icons.school_rounded)),
              const SizedBox(width: 12),
              Expanded(
                  child: _buildInputGroup(
                      'DURATION (MINS)', durationController, 'e.g., 60',
