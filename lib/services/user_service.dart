...
class UserService {
  ...
  /// Increment the total number of exams generated by a teacher
  Future<void> incrementExamsGenerated(String userId) async {
    await _db.collection('users').doc(userId).update({
      'examsGenerated': FieldValue.increment(1),
    });
    developer.log('Exams generated count incremented for user $userId',
        name: 'UserService');
  }
}
