...
class RecommendationService {
  ...
  List<StudyRecommendation> getDailyRecommendations(String userId) {
    ...
    return priorityTopics.map((topic) {
      ...
      if (topic.forgettingRisk > 0.7 && topic.masteryScore > 0.6) {
        return StudyRecommendation(
          ...
          description: 'Your memory is fading, but you know this well. A 2-minute review will lock it back in.',
        ...
        return StudyRecommendation(
          ...
          description: 'This is a weak spot. Let\'s try a quick quiz to strengthen the connections.',
        ...
        return StudyRecommendation(
          ...
          description: 'This concept is new and hasn\'t stabilized yet. Reading your notes again will help.',
